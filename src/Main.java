...
/**
 * Created by Francis Cáceres on 13/6/2016.
 */
public class Main {
       ...
       static class TSP{
        ...
        public TSP()
        {
            ...
            System.out.println("Digite el # de nodos: ");
            n=s.nextInt();
            weight=new int[n][n];
            tour=new int[n-1];
            for(int i=0;i<n;i++)

            {
                for(int j=0;j<n;j++)
                {
                    if(i!=j)
                    {
                        System.out.print("Introdusca el peso desde "+(i+1)+" hasta "+(j+1)+":=>");
                        weight[i][j]=s.nextInt();
                    }
                }
            }
            System.out.println();
            System.out.println("Se asume 1 nodo de entrada.");
            eval();
        }
        ...
        {
            System.out.println();
            System.out.print("El tour va desde 1-");
            for(int i=0;i<n-1;i++)
